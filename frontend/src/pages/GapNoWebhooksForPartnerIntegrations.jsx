...
// Batch 10 frontend page: "No webhooks for partner integrations" (nonai-gap) — muhittin
import React, { useEffect, useState } from 'react';

const SLUG = "no-webhooks-for-partner-integrations";
const LABEL = "No webhooks for partner integrations";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-webhooks-for-partner-integrations";

export default function GapNoWebhooksForPartnerIntegrations() {
