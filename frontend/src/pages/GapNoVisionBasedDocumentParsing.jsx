...
// Batch 10 frontend page: "No vision-based document parsing" (ai-gap) — muhittin
import React, { useEffect, useState } from 'react';

const SLUG = "no-vision-based-document-parsing";
const LABEL = "No vision-based document parsing";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-vision-based-document-parsing";

export default function GapNoVisionBasedDocumentParsing() {
