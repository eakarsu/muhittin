...
// Batch 10 frontend page: "No Salesforce / HubSpot / Pipedrive sync connector" (nonai-gap) — muhittin
import React, { useEffect, useState } from 'react';

const SLUG = "no-salesforce-hubspot-pipedrive-sync-connector";
const LABEL = "No Salesforce / HubSpot / Pipedrive sync connector";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-salesforce-hubspot-pipedrive-sync-connector";

export default function GapNoSalesforceHubspotPipedriveSyncConnector() {
