...
// Batch 10 frontend page: "Salesforce / HubSpot / Pipedrive bi-directional sync" (cfs) — muhittin
import React, { useEffect, useState } from 'react';

const SLUG = "salesforce-hubspot-pipedrive-bi-directional-sync";
const LABEL = "Salesforce / HubSpot / Pipedrive bi-directional sync";
const SECTION = "cfs";
const API_PATH = "/api/cf-salesforce-hubspot-pipedrive-bi-directional-sync";

export default function CfSalesforceHubspotPipedriveBiDirectionalSync() {
