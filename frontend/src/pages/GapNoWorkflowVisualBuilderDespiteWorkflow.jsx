...
// Batch 10 frontend page: "No workflow visual builder (despite workflow-automation route)" (nonai-gap) — muhittin
...
const API_PATH = "/api/gap-no-workflow-visual-builder-despite-workflow";

export default function GapNoWorkflowVisualBuilderDespiteWorkflow() {
