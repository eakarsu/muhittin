...
// Batch 10 frontend page: "No e-signature integration" (nonai-gap) — muhittin
import React, { useEffect, useState } from 'react';

const SLUG = "no-e-signature-integration";
const LABEL = "No e-signature integration";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-e-signature-integration";
