...
// Batch 10 frontend page: "No real-time meeting transcription + action-item extraction (voice-note module exists in name only)" (ai-gap) — muhittin
import React, { useEffect, useState } from 'react';

const SLUG = "no-real-time-meeting-transcription-action";
const LABEL = "No real-time meeting transcription + action-item extraction (voice-note module exists in name only)";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-real-time-meeting-transcription-action";

export default function GapNoRealTimeMeetingTranscriptionAction() {
